...
public class IncomeCategoryActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, OnTaskCompleted {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.income_category_activity);
        incomeCategoryExpListView = (ExpandableListView) findViewById(R.id.incomeCategoryExpListView);
    ...
    public void addIncomeCategory(View view) {
